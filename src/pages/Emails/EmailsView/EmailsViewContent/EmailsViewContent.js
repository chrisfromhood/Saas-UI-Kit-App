import cs from "./EmailsViewContent.module.css";
import StatusTag from "../../../../components/StatusTag/StatusTag";
import arrowUp from "../../../../assets/img/icons/arrow-up-gray.svg";
import bin from "../../../../assets/img/icons/baseline-delete.svg";
import coverImage from "../../../../assets/img/big/internal_email.jpg";


function EmailsViewContent() {
  return (
    ...
    <div className={cs["email-view_section"]}>
      ...
      <div className={cs["email-view_content"]}>
        ...
        <img src={coverImage} alt="Cover" className={cs["cover"]} />
...
export default EmailsViewContent;